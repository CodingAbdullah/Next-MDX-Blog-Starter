        ...
        <div className="min-h-screen bg-background">
            <div className="max-w-5xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-8">
                <div className="mb-4 sm:mb-6 text-center">
                    <h1 className="text-2xl sm:text-3xl font-bold text-green-700 dark:text-green-300 matrix-glow code-font">
                        Blog Assistant
                    </h1>
                    <p className="text-sm text-green-600/80 dark:text-green-600 mt-1 code-font">
