...
export default function CodeSandboxFeaturesSection(): React.JSX.Element {
    return (
        <section className="pb-8 sm:pb-12">
            <h3 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 matrix-glow text-center text-green-700 dark:text-green-300">Sandbox Features</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                <div className="glass-card p-6 text-center">
                    ...
                    <h4 className="text-lg font-semibold mb-2 matrix-glow text-green-700 dark:text-green-300">Secure Sandbox</h4>
                ...
                <div className="glass-card p-6 text-center">
                    ...
                    <h4 className="text-lg font-semibold mb-2 matrix-glow text-green-700 dark:text-green-300">Easy Copy</h4>
                    <p className="text-sm text-green-700/70 dark:text-green-200/70 code-font">
