...
export default function CodeSandboxFeaturesSection(): JSX.Element {
    return (
        <section className="pb-8 sm:pb-12">
            <h3 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 matrix-glow text-center">Sandbox Features</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                <div className="glass-card p-6 text-center">
                    ...
                    <h4 className="text-lg font-semibold mb-2 matrix-glow">Secure Sandbox</h4>
                ...
                <div className="glass-card p-6 text-center">
                    ...
                    <h4 className="text-lg font-semibold mb-2 matrix-glow">Instant Execution</h4>
                    <p className="text-sm text-green-200/70 code-font">
                ...
                <div className="glass-card p-6 text-center">
                    ...
                    <h4 className="text-lg font-semibold mb-2 matrix-glow">Easy Copy</h4>
                    <p className="text-sm text-green-200/70 code-font">
                ...
                <div className="glass-card p-6 text-center">
                    ...
                    <h4 className="text-lg font-semibold mb-2 matrix-glow">JS & TypeScript</h4>
                    <p className="text-sm text-green-200/70 code-font">
